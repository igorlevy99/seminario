...
<head>
    ...
    <link rel="stylesheet" href="../seminario/bootstrap/css/bootstrap.css">
...
<body>
    ...
    <aside id="header">
        ...
        <section class="profile">
            <img src="../seminario/img/logo.jpeg" alt="Foto do Igor">
            <h1>Barbearia</h1>
        </section>
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="10000">
                            <div class="row row-cols-1 row-cols-md-3 g-4">
                                <div class="col">
                                    <div class="card">
                                        <img src="../seminario/img/corte_curto.png" class="card-img-top" alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img src="../seminario/img/corte_medio.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img src="../seminario/img/corte_longo.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
    ...
    <script src="../seminario/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="pagina_inicial.js"></script>
</body>
</html>